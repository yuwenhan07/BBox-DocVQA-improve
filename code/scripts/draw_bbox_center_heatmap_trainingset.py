...
def collect_bbox_center_heatmap(input_path, reference_png_path, rows, cols):
...
def build_heatmap_data(input_path, reference_png_path, rows, cols, sigma):
...
def main():
    ...
    parser.add_argument(
        ...
        help="Reference PNG used for all bbox position normalization.",
    )
    parser.add_argument(
        "--output",
